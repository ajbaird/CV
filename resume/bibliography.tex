...
\begin{refsection}
  ...
  \nocite{baird2021multiscale}
  \nocite{Grey2024Increasing}
  \nocite{baird2025whole}
  \nocite{baird2024whole}
  \nocite{bairdtowards}
...
\begin{refsection}
    ...
    \nocite{tatum_nathan_2021_5196289}
    \nocite{tatum_nathan_2021_5013318}
    \nocite{Baird_2024}
	\newrefcontext[sorting=ynt]
	\printbibliography[heading=none]
\end{refsection}
...
\begin{refsection}
    \nocite{baird2025Automated}
    \nocite{baird2025Lactate}
    \nocite{baird2025Gender}
    \nocite{baird2025Physical}
    \nocite{Gong2025Physiology}
	\newrefcontext[sorting=nyt]
	\printbibliography[heading=none]
\end{refsection}
...
\cvsubsection{Final Section: List of Abstracts}
  ...
  \cventry
    {Whole Body PBPK Model of Nasal Naloxone Administration to Measure Repeat Dosing} % Empty position
    {} % Project
    {} % Empty location
    {} % Empty date
     {
